			...
			<div className="max-w-7xl mx-auto px-6">
				<div className="flex items-center justify-between h-16">
					...
					<div className="hidden md:flex items-center gap-8">
						...
						<a
							href="/contact"
							className="bg-emerald-500 hover:bg-emerald-600 text-black font-medium px-5 py-2 rounded-lg text-sm transition-colors"
						>
							Teklif Al
						</a>
					</div>
				...
				<div className="md:hidden bg-black/95 backdrop-blur-lg border-t border-white/5">
					<div className="px-6 py-4 space-y-3">
						...
						<a
							href="/contact"
							onClick={() => setMenuOpen(false)}
							className="block bg-emerald-500 text-black font-medium px-5 py-3 rounded-lg text-center mt-4"
						>
							Teklif Al
						</a>
					</div>
