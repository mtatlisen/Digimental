---
title: Welcome to Digimental
description: Digimental documentation and guides.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Digimental documentation and guides.
  image:
  ...
  actions:
    - text: Example Guide
      link: /guides/example/
      icon: right-arrow
    - text: Visit digimental.com.tr
      link: https://www.digimental.com.tr
      icon: external
      variant: minimal
---
